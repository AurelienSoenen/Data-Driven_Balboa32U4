...
rdmGains = (1:2:100)*0.0001;
% Loop over rdmGains values
BestRdm = 0;
% Loop over T values
for rdmGain = rdmGains
    ...
    for t = 1:T-1
        ...
        rdm_state_measurement = rdm_state_measurement*rdmGain;
...
plot(rdmGains*1000, eig_diff1_values, 'k-o', 'LineWidth', 1.25, 'MarkerFaceColor', 'k');
hold on;
plot(rdmGains*1000, eig_diff2_values, 'k--o', 'LineWidth', 1.25, 'MarkerFaceColor', 'w');

% Adding labels
xlabel('Noise std [mrad]');
ylabel('MRE [-]');
...
% Save the figure
saveas(gcf, fullfile(folderName, 'NoiseExcitement.png'));
