...
% Write to CSV files
csvwrite(fullfile(folderName, 'NoExcitementVarPolePlot1.csv'), data1);
csvwrite(fullfile(folderName, 'NoExcitementVarPolePlot2.csv'), data2);

% Alternatively, include headers using fprintf for each file
fileID1 = fopen(fullfile(folderName, 'NoExcitementVarPolePlot1.csv'), 'w');
fprintf(fileID1, 'x,p1,p2,p3,p4\n');
fclose(fileID1);
dlmwrite(fullfile(folderName, 'NoExcitementVarPolePlot1.csv'), data1, '-append');

fileID2 = fopen(fullfile(folderName, 'NoExcitementVarPolePlot2.csv'), 'w');
fprintf(fileID2, 'x,p1,p2,p3,p4\n');
fclose(fileID2);
dlmwrite(fullfile(folderName, 'NoExcitementVarPolePlot2.csv'), data2, '-append');
