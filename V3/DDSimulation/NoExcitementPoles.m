...
% Write to CSV
csvwrite(fullfile(folderName, 'NoExcitementPoles.csv'), data);

% Optionally, include headers using fprintf
fileID = fopen(fullfile(folderName, 'NoExcitementPoles.csv'), 'w');
fprintf(fileID, 'x,y1,y2\n');
fclose(fileID);
dlmwrite(fullfile(folderName, 'NoExcitementPoles.csv'), data, '-append');
