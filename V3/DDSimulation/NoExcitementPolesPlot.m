...
% Write to CSV
csvwrite(fullfile(folderName, 'NoExcitementPolesPlot.csv'), data);

% Optionally, include headers using fprintf
fileID = fopen(fullfile(folderName, 'NoExcitementPolesPlot.csv'), 'w');
fprintf(fileID, 'x,p11,p12,p13,p14,p21,p22,p23,p24\n');
fclose(fileID);
dlmwrite(fullfile(folderName, 'NoExcitementPolesPlot.csv'), data, '-append');
